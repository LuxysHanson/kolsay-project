    ...
    <section class="section-our-tour">
        <div class="our-tour-block">
            ...
            <div class="our-tour-item center order-4 order-md-3">
                <div class="item ml-3">
                    <p class="h4-title mb-3">Озеро Кайынды</p>
                    <p class="txt-22-w4 mb-4">Достаточно молодое озеро в Казахстане с бирюзовой водой и елями, будто вросшими в него. Оно образовалось в ходе оползня известняка и просадки грунта, случившегося в результате Кеминского землетрясения в 1911 году.</p>
                    <p>ПОДРОБНЕЕ О МАРШРУТЕ</p>
                </div>
            </div>
            ...
            <div class="our-tour-item center order-6">
                <div class="item">
                    <p class="h4-title mb-3">Ущелье Саты</p>
                    <p class="txt-22-w4 mb-4">Нижняя часть ущелья пролегает через небольшие прилавки. Затем оно углубляется и так простирается до высокогорной зоны. Склоны ущелья в средней части покрывают еловые леса.</p>
                </div>
            </div>
            <div class="our-tour-item center order-8 order-md-7">
                <div class="item ml-3">
                    <p class="h4-title mb-3">Перевал Курметты</p>
                    <p class="txt-22-w4 mb-4">На перевал Курменты надо идти от второго оз.Кольсай направо по долине р.Умурзак (на карте названия нет, ее так местные называют).
                        Тропа начинается сразу за бревнами и уходит круто в лес - 1 час.</p>
                    <p>ПОДРОБНЕЕ О МАРШРУТЕ</p>
                </div>
            </div>
